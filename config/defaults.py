...
# CrossModality Module
_C.MODEL.MODULE = ''
_C.MODEL.ADV_LOSS_WEIGHT = 1.0
_C.MODEL.JMMD_LOSS_WEIGHT = 1.0
_C.MODEL.OT_LOSS_WEIGHT = 1.0
_C.MODEL.JMMD_LOSS_WEIGHT_R = 1.0
_C.MODEL.JMMD_LOSS_WEIGHT_U = 1.0
# -----------------------------------------------------------------------------
# INPUT
# -----------------------------------------------------------------------------
_C.INPUT = CN()
...
_C.SOLVER.STAGE2.MAX_EPOCHS_1 = 0
_C.SOLVER.STAGE2.MAX_EPOCHS_N = 0
# Base learning rate
