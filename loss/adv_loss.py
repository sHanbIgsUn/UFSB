...
from module.grl import WarmStartGradientReverseLayer
from utils.adv_acc import binary_accuracy, accuracy
...
class DomainAdversarialLoss(nn.Module):
    ...
    def forward(self, f_s: torch.Tensor, f_t: torch.Tensor,
        ...
        if self.sigmoid:
            ...
            loss = F.cross_entropy(d, d_label, reduction='none') * w
