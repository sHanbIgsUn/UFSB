...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x: torch.Tensor, cv_emb=None, instance_tokens=None):
        ...
        return x11, x12, xproj #,img_feats
...
def build_model(state_dict: dict, h_resolution: int, w_resolution: int, vision_stride_size: int,two_branch = False):
